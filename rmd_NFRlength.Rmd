...
* 1st settings do not capture -1 properly (there is a small nuclesome in between)
* 3rd settings look the most reasonable
...
* the profiles with high correlation look reasonable
